            ...
            <div className='bg-zinc-100 p-8 w-[600px] rounded-lg border-1 border-zinc-300'>
                ...
                <div>
                    ...
                    <div className='flex justify-between pt-3 border-t-1 border-zinc-300 mb-5 '>
                        ...
                        <span className='text-indigo-600 font-bold text-xl'>Order Total</span>
                        <span className='text-indigo-600 font-bold text-xl'>${orderTotal.toFixed(2)}</span>
                ...
                <div className='flex mt-10 gap-x-3'>
                    ...
                    <button className='bg-indigo-600 flex-1 py-3 active:bg-zinc-900 text-white rounded-lg cursor-pointer '
